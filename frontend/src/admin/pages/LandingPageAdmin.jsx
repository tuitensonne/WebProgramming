...
export default function LandingPageAdmin() {
  ...
  return (
    <div className="page-wrapper p-4" style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div className="page-header d-flex justify-content-between mb-3">
        ...
        <div className="d-flex gap-2">
          {changed && (
            <>
              <button className="btn btn-outline-secondary d-flex align-items-center gap-1" onClick={handleCancelChanges}>
