...
const AddSectionModal = ({
    ...
    const renderContentForm = () => {
        ...
        const layoutFields =
            layoutOptions.find((l) => l.id === selectedLayout.id)
                ?.defaultContent || {};
            ...
            <div className="space-y-3">
                ...
                {selectedLayout.id === "about_testimonials" && (
                    <div className="alert alert-info">
                        <strong>Lưu ý:</strong> Section Đánh giá lấy dữ liệu
                        trực tiếp từ bảng Comment và không thể chỉnh sửa nội
                        dung đánh giá tại đây.
                    </div>
                )}
            </div>
        );
                        ...
                        >
                            ...
                            {sections.length === 0 && (
                                <div className="alert alert-warning text-center mt-3">
                                    Chưa có Section nào cho trang About Us. Hãy
                                    nhấn "Thêm Section" để bắt đầu!
                                </div>
                            )}
                        </div>
                    )}
